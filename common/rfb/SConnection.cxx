...
void SConnection::clipboardRequest(rdr::U32 flags)
{
...
void SConnection::clipboardPeek(rdr::U32 flags)
{
  if (!hasLocalClipboard)
    return;
...
void SConnection::clipboardNotify(rdr::U32 flags)
{
  strFree(clipboard);
  clipboard = NULL;
...
void SConnection::clipboardProvide(rdr::U32 flags,
